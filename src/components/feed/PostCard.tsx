          ...
          <div className="relative w-full bg-muted">
            ...
            {images.length === 1 && (
              <div className="relative aspect-[4/3] w-full">
                <Image src={images[0]} alt={post.desc || 'Post image'} fill className="object-cover" sizes="(max-width: 640px) 100vw, 512px" unoptimized />
              </div>
            )}
              ...
              <div className="grid grid-cols-2 gap-0.5 aspect-[2/1]">
                {images.map((img, i) => (
                  <div key={i} className="relative w-full h-full">
                    <Image src={img} alt={`Image ${i + 1}`} fill className="object-cover" sizes="256px" unoptimized />
                  </div>
                ))}
              </div>
            )}
            ...
            {images.length === 3 && (
              <div className="grid grid-cols-2 gap-0.5" style={{ aspectRatio: '4/3' }}>
                <div className="relative row-span-2">
                  <Image src={images[0]} alt="Image 1" fill className="object-cover" sizes="256px" unoptimized />
                </div>
                <div className="relative">
                  <Image src={images[1]} alt="Image 2" fill className="object-cover" sizes="256px" unoptimized />
                </div>
                <div className="relative">
                  <Image src={images[2]} alt="Image 3" fill className="object-cover" sizes="256px" unoptimized />
                </div>
              </div>
            )}
